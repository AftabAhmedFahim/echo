...
from settings import GREEN, YELLOW, ORANGE, CYAN, HOLD_INTERACT_TIME, INTERACT_RANGE
...
class AudioLog(Interactable):
    def __init__(self, x: int, y: int, text: str):
        super().__init__(x, y, 30, 30, "Play Audio Log")
        self.text = text

    def draw(self, surface: pygame.Surface) -> None:
        color = (255, 180, 80) if self.completed else (200, 120, 50)
